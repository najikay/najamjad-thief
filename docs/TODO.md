...
- [ ] **T-2443** (P1) Dialogue and Match-report panels are still dead: `record_message` and `record_report` have no production callers — DoD: hints appear in the transcript; the email panel shows the message id
