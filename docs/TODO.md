...
- [ ] **T-2484** (P1) Point the search at the **cop**, which is where the points are: it is worth its 5-point survival floor and both dials measured 0/24 at every value against a correct thief. Needs arenas that are not already saturated, or it will report the same flat landscape — DoD: a cop arena with a measurable gradient before any tuning run is trusted
